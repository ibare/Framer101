...
naverbnt.onClick ->
	radio_off_2xA.opacity = 1
	radio_on_2xA.animate
		opacity: 0
	toggle_01_2x.animate
		opacity: 0	
	radio_off_2x.opacity = 0
	radio_on_2x.animate
		opacity: 1
		delay: .3
	toggle_01_2xA.animate
		opacity: 1
		delay: .3
	btn_01_2x.animate
		opacity: 1
